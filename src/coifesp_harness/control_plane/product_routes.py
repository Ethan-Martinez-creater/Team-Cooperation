...
def _task_view(task) -> TeamTaskView:
    ...
    return TeamTaskView(
        ...
        produced_by_principal_id=task.produced_by_principal_id,
        source_planner_run_id=task.source_planner_run_id,
        source_planner_command_id=task.source_planner_command_id,
        title=task.title,
